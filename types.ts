export enum Permission {
  ...
  // ========== User Management ==========
  CAN_MANAGE_USERS = 'CAN_MANAGE_USERS', // Broad: view, create, edit, archive, restore
  ...
  CAN_MANAGE_ROLES = 'CAN_MANAGE_ROLES', // Broad: view, create, edit, delete, assign permissions

  // ========== Business Unit Management ==========
  CAN_MANAGE_BUSINESS_UNITS = 'CAN_MANAGE_BUSINESS_UNITS', // Broad: view, create, edit, archive, delete, assign

  // ========== Task Management ==========
  CAN_MANAGE_TEAM_TASKS = 'CAN_MANAGE_TEAM_TASKS', // Broad: view, create, edit, delete, assign, comment
  ...
  CAN_MANAGE_TEAM_REPORTS = 'CAN_MANAGE_TEAM_REPORTS', // Broad: view team reports, track consistency
