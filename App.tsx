...
const AppContent: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      {(hasPermission(Permission.CAN_USE_GOOGLE_CALENDAR) || hasPermission(Permission.CAN_USE_TELEGRAM_BOT) || hasPermission(Permission.CAN_USE_GEMINI_AI)) && <Route path="/integrations" element={<IntegrationsPage />} />}
